...
class FinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fine" do
    assert_difference('Fine.count') do
      post fines_url, params: { fine: { description: @fine.description, name: @fine.name, price: @fine.price } }
    end
  ...
  test "should update fine" do
    patch fine_url(@fine), params: { fine: { description: @fine.description, name: @fine.name, price: @fine.price } }
